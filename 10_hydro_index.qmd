...
Mezi empirické lze řdit například
...
a jim podobné hodnoty získané z dat kombinací filtrace, agregace a volby mezních hodnot. 
Za stochastické potom budeme označovat ty, ve kterých je v nějaké míře pracováno se 
statistickým rozdělením.
...
2.  Upravte metodu 30denních klouzavých minim pro výpočet základního odtoku tak, 
