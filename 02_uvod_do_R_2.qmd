...
Vektor je v jazyce R základní stavební strukturou, nic jaká skalární veličina zde není. Koncept vektoru je zde chápán v matematickém smyslu jako jednosloupcová matice $\boldsymbol{A} = (a_{ij})_{m1}$ hodnot v $n-$dimenzionálním prostoru.
...
```
  ...
  4. Vyberte, platné tvrzení pro data.frame: `r longmcq(opts = opts1)`
