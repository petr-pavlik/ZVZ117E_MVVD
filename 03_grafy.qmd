...
```
1. K vytvoření proměnné $Y$ použijeme generování čísel z náhodného rozdělení s parametry $\mu = 0$ a $\sigma = 1$; více v kapitole @sec-rozdeleni
...
### Sazba s funkcí `layout()` a matice
