...
```{r základní aritmetické operace, eval=TRUE, collapse=TRUE}
1 + 1          # přičítání
2 - 1          # odečítání
1 * 3.         # násobení
1 * (-1)       # násobení
...
Homogenní datové struktury obsahují atomické vektory, matice a pole. Název je odvozen od jejich omezení 
