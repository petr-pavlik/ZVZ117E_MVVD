...
| Kapitola              | Soubor                                                                                                          | Popis                                   | Citace |
|--------------|-------------------------------|--------------|--------------|
| @sec-grafy Úloha 3    | [![P2VSEL01_SRA_N.csv](images/mage--file-download.svg){alt="P2VSEL01_SRA_N.csv" width="28"}](./data/budyko_dfr) | Dlouhodobá klimatická bilance na povodí | \-     |
