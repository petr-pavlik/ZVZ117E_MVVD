...
Předmět MVVD navazuje na předmět *Počítačové zpracování dat*, který je zaměřen na obecnou práci s R. 
Kapitoly 3-5 jsou zde řazeny pouze pro potřeby opakování a jejich obsah je na cvičení brán v rychlém tempu. \

**Předpokládá se, že na cvičení se student dopředu připaví jednak účastí na přednášce a dále samostudiem.**

## Členění textu

Text je členěn do "kapitol" podle náplně jednotlivých cvičení. Na začátku každé kapitoly jsou vypsány **Cíle cvičení**, k jejichž osvojení daná kapitola míří. V textu i na konci každé kapitoly jsou cvičení s aktivní kontrolou správného řešení. V **Poznámce** jsou doplňující informace nad rámec cvičení.
