...
|--------------|-------------------------------|--------------|--------------|
| @sec-grafy Úloha 3    | [![budyko_dfr](images/mage--file-download.svg){alt="P2VSEL01_SRA_N.csv" width="28"}](/data/budyko_dfr.rds) | Dlouhodobá klimatická bilance na povodích | \-     |
