...
#### Cvičení {-}
**7.2** Generujte s pomocí funkce `rnorm` postupně $10$, $10^2$, $10^3$, $10^4$ 
čísel se shodnou střední hodnotou a shodným rozptylem. Spočítejte $\bar{x}$ a ${s^2}$
Okomentujte výsledky. Použijte nápovědu.
