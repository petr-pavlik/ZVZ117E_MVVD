...
Poissonovo rozdělení (jinak také rozdělení vzácných jevů) je získáno aproximací 
binomického rozdělení v případech, kdy počet pozorování se limitně blíží k
nekonečnu ($N\rightarrow \infty$)
...
Pro odhad a konstrukci $m-$denních průtoků používá Český hydrometeorologický ústav logaritmicko-normální 
