...
Balík `stats` obsahuje mnoho rozdělení. Alternativní, Binomické, Multinomické, **Poissonovo**, **Normální**, **Fischer-Snedecorovo**, $\chi^2$, **Studentovo** $t$ a mnohá další. Podívejte se na `?Distributions`.

Pro úplnost uvedeme funkce pro permutace `factorial()` a kombinace `choose()`.
...
nebo menších než konkrétní hodnota.
