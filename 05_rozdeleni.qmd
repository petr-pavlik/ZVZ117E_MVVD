...
2.
    ...
    a)  V @sec-grafy jsme si představovali funkci `curve()`. Pro praktické 
    počítání s Normální rozdělením je užitečné si pamatovat pravděpodobnosti
    vybraných intervalů $\mu\pm\{1,2,3\}\sigma$.\ 
    S pomocí funkce `integrate()`  
    $$
