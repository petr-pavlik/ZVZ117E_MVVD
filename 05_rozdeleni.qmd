...
$$
    b) Máme náhodnou veličinu $X$, jež sleduje Normální rozdělení s parametry $\mu = 5$ a $\sigma^2 = 4,13$, nebo-li $X\sim \mathsf{N}(5; 4,13)$. Jaká je pravděpodobnost:\     
      - $P(X < 8)$\         
      - $P(X \leq 8)$\         
      - $P(X > 12,4)$\      
...
## Cvičení
  ...
  `c(15*` `r fitb(8.6)` `/qchisq(` `r fitb(0.975)`,  `r fitb(15)` `),` `15*` `r fitb(8.6)` `/qchisq(` `r fitb(0.025)`,  `15` `))`         
